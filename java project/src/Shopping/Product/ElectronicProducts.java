...
{
    Vector<product> electronic = new Vector<>();
    ...
    String[] prodSellerName ={"APPLE","ONEPLUS","SONY","LG","SAMSUNG","BAJAJ","BAJAJ","APPLE","APPLE","VOLTS","CANON","SONY","SAMSUNG"};
    ...
    public static void main(String[] args)
    {
        ...
        prodMain.addElectronicProductDetails();
    }
    public void addElectronicProductDetails()
    {
        ...
        for(int i=0;i<13;i++)
        {
            try
            {
                ElectronicProductDescriptionFile = new File("C:\\Users\\sahoo\\IdeaProjects\\java project\\src\\Shopping\\ElectronicProductsDescription.csv");
                while(true)
                {
                    assert false;
