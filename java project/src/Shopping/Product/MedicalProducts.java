...
{
    Vector<product> medical = new Vector<>();
    ...
    public static void main(String[] args)
    {
        ...
        prodMain.addMedicalProductDetails();
    }
    ...
    public void addMedicalProductDetails()
    {
        ...
        for(int i=0;i<13;i++)
        {
            try
            {
                MedicalProductDescriptionFile = new File("C:\\Users\\sahoo\\IdeaProjects\\java project\\src\\Shopping\\MedicalProductsDescription.csv");
