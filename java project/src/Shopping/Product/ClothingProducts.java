...
{
    Vector<product> clothing = new Vector<>();
        ...
        do{
            ...
            switch(ch)
            {
                ...
                case 13:
                    ...
                    break;
                case 14:
                    System.out.println("ENTER PRODUCT NAME YOU ARE SEARCHING ");
                    ob.nextLine();
                    search(ob.nextLine());
                    break;
                case 15:
...
//bubble sort is used in this code
    //leter
...
//bubble sort is used in this code
    ...
    public static void main(String[] args)
    {
        ...
        prodMain.addClothingProductDetails();
    }
    public void addClothingProductDetails()
    {
        ...
        for(int i=0;i<13;i++)
        {
            try
            {
                ClothingProductDescriptionFile = new File("C:\\Users\\sahoo\\IdeaProjects\\java project\\src\\Shopping\\ClothingProductsDescription.csv");
