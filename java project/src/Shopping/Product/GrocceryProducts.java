...
public class GrocceryProducts extends product
{
    ...
    Vector<product> groccery = new Vector<>();
    ...
    public static void main(String[] args)
    {
        ...
        prodMain.addGrocceryProductDetails();
    }
    public void addGrocceryProductDetails()
    {
        ...
        for(int i=0;i<13;i++)
        {
            try
            {
                GrocceryProductDescriptionFile = new File("C:\\Users\\sahoo\\IdeaProjects\\java project\\src\\Shopping\\GrocceryProductsDescription.csv");
