    ...
    public void edit(customer thisCustomer)
    {
        ...
        try
        {
            ...
            while(scanner.hasNextLine())
            {
                ...
                customer customerOB;
                if(cStr[4].equalsIgnoreCase("Email"))
                {
                    continue;
                }
            ...
            {
                fileWriter.write(j +","+ addToCustomerList.customerID +","+addToCustomerList.customerName+","+ addToCustomerList.customerPhoneNo +","+addToCustomerList.customerEmail+","+addToCustomerList.customerAddress+","+ addToCustomerList.customerCredits +","+addToCustomerList.customerPassword+",\n");
                j++;
            }
            fileWriter.close();
            customerList.clear();
    ...
    public void delete(customer thisCustomer)
    {
        ...
        if(ch==1)
        {
            ...
            try
            {
                ...
                for(customer addToCustomerList:customerList)
                {
                    fileWriter.write(MessageFormat.format("{0},{1},{2},{3},{4},{5},{6},{7},\n", Integer.toString(j), Long.toString(addToCustomerList.customerID), addToCustomerList.customerName, Long.toString(addToCustomerList.customerPhoneNo), addToCustomerList.customerEmail, addToCustomerList.customerAddress, Long.toString(addToCustomerList.customerCredits), addToCustomerList.customerPassword));
                    j++;
                }
                fileWriter.close();
                customerList.clear();
