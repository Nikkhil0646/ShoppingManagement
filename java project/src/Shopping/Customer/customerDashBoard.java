...
public class customerDashBoard extends customer{
    ...
    // view product is not working io is fails....
    ...
    {
        if(!thisCustomer.customerCart.isEmpty())
        {
            System.out.println("\t SURE YOU WANT TO BUY ?");
            int sureBuy = ob.nextInt();
            if(sureBuy!=0)
            {
                customerPayment(thisCustomer);          //call payment method()
            }
            else
            {
                System.out.println("\t Redirected ...");                                                                            //break;
            }
        }
    }
    public void orderedProducts(customer thisCustomer)
    {
        if(!thisCustomer.customerOrders.isEmpty())
        {
    ...
    {
        if(!thisCustomer.customerCart.isEmpty())                                                                          //product buyedProducts = new ClothingProducts();
        {
            ...
            switch(ob.nextInt())
            {
                ...
                case 2:
                    ...
                    ob.nextLine();
                    removeFromCart(ob.nextLine());
                    break;
                case 0:
                    System.out.println(" HOLD ON TILL WE LOAD : ) \n");
                    confirmBuyProducts(this);                                                                                                       //buyProducts();//buyedProducts.billing(this,customerCart);
                    break;
                default:
                    System.out.println("INVALID CHOICE \n");
                    break;
    ...
    public void customerWishlist(customer thisCustomer)
    {
        ...
        if(!thisCustomer.customerWishList.isEmpty())
        {
    ...
    public void removeFromCart(String toRemoveProduct)
    {
